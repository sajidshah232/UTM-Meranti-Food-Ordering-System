...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0">
                        <a class="navbar-brand" href="#" style = "position:relative; left:80px; color: white;">OrderLah  </a>
                    </ul>           
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Arkeds</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">All Arkeds</a></li>
        ...
        <div class="page-wrapper" >
            ...
            <div class="col-lg-12" >
                        <div class="card card-outline-primary"style="background-color:whitesmoke; border: black;" >
                            <div >
                                <h2 class="m-b-0 text-dark">Admin Analytics Dashboard</h2s>
                            </div>
                     <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <!-- <span><i class="fa fa-myr f-s-40" aria-hidden="true"></i></span> MYR SIgn --> 
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php 
