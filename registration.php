...
<body>
<div style=" background-image: url('images/img/utmbg.jpg');">
               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     <ul class="nav navbar-nav">
							<li class="nav-item"> <a class="nav-link active" href="index.php">Back <span class="sr-only"></span></a> </li> 
						...
						if(empty($_SESSION["user_id"]))
							...
							{		
										echo  '<li class="nav-item"><a href="index.php" class="nav-link active">Login</a> </li>';
									// echo  '<li class="nav-item"><a href="logout.php" class="nav-link active">Register</a> </li>';
							}

						?>
							 <!-- <li class="nav-item"> <a class="nav-link active" href="#"> <i class="fa-solid fa-user"></i> <span class="sr-only"></span></a> </li> -->
                        </ul>
                  </div>
               </div>
            </nav>
